...
The design separates confidentiality from hiding. Confidentiality is always enabled and ensures that transaction amounts and balances remain encrypted. Compliant unlinkability is optional for our partners only if necessary for certain applications such as merchants, funds, or market makers. This mirrors how encryption is universally used on the internet (e.g. HTTPS), while stronger privacy tools (e.g. VPNs) are applied selectively.
